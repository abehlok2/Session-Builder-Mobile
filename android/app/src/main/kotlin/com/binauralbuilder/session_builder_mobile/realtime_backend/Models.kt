...
data class NoiseParams(
    ...
    @SerializedName("color_params")
    val noise_parameters: Map<String, JsonElement> = emptyMap(),
    ...
    val high_exponent: Float? = null,
    val distribution_curve: Float? = null,
...
data class VoiceData(
    ...
    val volumeEnvelope: List<List<Float>>? = null,
...
data class StepData(
    ...
    @SerializedName("binaural_volume")
    val binauralVolume: Float = MAX_INDIVIDUAL_GAIN,
    @SerializedName("noise_volume")
    val noiseVolume: Float = MAX_INDIVIDUAL_GAIN,
...
data class ClipData(
    ...
    @SerializedName("gain", alternate = ["amp"])
    val amp: Float = 1.0f
)
...
data class BackgroundNoiseData(
    ...
    @SerializedName("amp_envelope")
    val ampEnvelope: List<FloatArray> = emptyList()
)
